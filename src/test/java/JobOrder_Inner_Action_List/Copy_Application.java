...
public class Copy_Application {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[9]/a")).click(); // Copy Application
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//*[@id=\"copyApplicationForm\"]/div/div[2]/input[2]")).click();
