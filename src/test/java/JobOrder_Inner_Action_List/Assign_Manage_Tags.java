...
public class Assign_Manage_Tags {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement assignTags = driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[21]/a"));
        js.executeScript("arguments[0].scrollIntoView(true);", assignTags); // Assign Manage Tags
        assignTags.click();
		...
		WebElement assignTags1 = driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[21]/a"));
        js.executeScript("arguments[0].scrollIntoView(true);", assignTags1); // Assign Manage Tags
        assignTags1.click();
