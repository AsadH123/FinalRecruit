...
public class Send_Email_To_Contact {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement sendEmailToContact = driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[17]/a"));
        js.executeScript("arguments[0].scrollIntoView(true);", sendEmailToContact); // Send Email To Contact
		
		sendEmailToContact.click();
		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//*[@name='subject']")).sendKeys("Testing Send Email To Contact");
