...
public class Update_Job_Status {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement updateJobStatus = driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[18]/a"));
        js.executeScript("arguments[0].scrollIntoView(true);", updateJobStatus); // Update Job Status
        updateJobStatus.click();
        
        Thread.sleep(2000);
        WebElement status = driver.findElement(By.xpath("//*[@id=\"module_status_id[]\"]"));
        Select select = new Select(status);
        select.selectByVisibleText("On Hold");
        
        driver.findElement(By.xpath("//*[@id=\"comments[]\"]")).sendKeys("Testing Update Job Status");
