...
public class Associate_Candidate {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[2]/a")).click(); // Associate Candidate
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"select2-candidate_ids-results\"]/li[6]")).click();
