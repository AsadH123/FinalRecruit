...
public class Add_Note {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		comment.sendKeys("Test Note Has Been Added in Contacts Asghar Zaidi"); // Comment
		...
		WebElement Note_Text = driver.findElement(By.id("28464"));
        ...
        Thread.sleep(2000);
        String expectedText = "Test Note Has Been Added in Contacts Asghar Zaidi"; // Expected text
