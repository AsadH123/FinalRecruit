...
public class Reminder {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.linkText("Campaigns")).click(); // Candidates Tab
		Thread.sleep(2000);
		...
		driver.findElement(By.linkText("Test Campaign No 1")).click(); // Contact Link Text
		
		driver.findElement(By.xpath("//*[@data-original-title='Reminder']")).click(); // Click on New Reminder Icon
