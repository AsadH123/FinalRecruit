...
public class New_Reminder {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[4]/a")).click();
		
		driver.findElement(By.xpath("//*[@name='reminder_description']")).sendKeys("Testing Reminder");
		driver.findElement(By.id("reminder_date")).click();
		driver.findElement(By.className("ui-datepicker-current-day")).click();
		
		driver.findElement(By.id("reminder_time")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@name='hour']")).sendKeys("08");
		driver.findElement(By.xpath("//*[@name='minute']")).sendKeys("45");
		driver.findElement(By.xpath("//*[@name='meridian']")).sendKeys("PM");
