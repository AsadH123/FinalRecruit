...
public class companies_csv {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"sticky\"]/div[2]/div[1]/button")).click(); // Right-Hand-Side Menu
		...
		upload_file.sendKeys("C:\\Users\\Asad\\Desktop\\Companies.csv");
