...
public class Internal_Reject {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[3]/a")).click(); // Internal Reject Status Change
		
		Thread.sleep(2000);
		WebElement chkbox = driver.findElement(By.xpath("//*[@data-statusid='72']"));
		...
		WebElement chkBoxEmail = driver.findElement(By.xpath("//*[@data-module-status-trigger-id='498']"));
		if(!chkBoxEmail.isSelected())
			chkBoxEmail.click();
		Thread.sleep(1000);
		
		driver.findElement(By.xpath("//*[@name='trigger_subject_498']")).sendKeys(" Successfully");
		
		WebElement emailTemplate = driver.findElement(By.className("userEmailTemplatesListtrigger_498"));
