...
public class Unavailable {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement chkbox = driver.findElement(By.xpath("//*[@data-statusid='63']"));
		...
		WebElement chkBoxEmail = driver.findElement(By.xpath("//*[@data-module-status-trigger-id='528']"));
		...
		driver.findElement(By.xpath("//*[@name='trigger_subject_528']")).sendKeys(" Successfully");
		
		WebElement emailTemplate = driver.findElement(By.className("userEmailTemplatesListtrigger_528"));
