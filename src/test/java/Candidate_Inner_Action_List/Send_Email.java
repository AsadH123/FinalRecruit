...
public class Send_Email {
    public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[9]/a")).click(); // Send Email

        Thread.sleep(1000);
        WebElement application = driver.findElement(By.id("career_application_id"));
        Select Application = new Select(application);
        Application.selectByVisibleText("Entry Test");
		...
		WebElement inside_iframe = driver.findElement(By.xpath("/html"));
		inside_iframe.click();
		Thread.sleep(1000);
		inside_iframe.sendKeys("Testing Add Note inner list"); // Comments
		driver.switchTo().defaultContent();

        driver.findElement(By.xpath("//*[@id='sendCareerApplicationForm']/div[2]/input[2]")).click();
    }
