...
public class Shortlisted {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[3]/a")).click(); // Shortlisted Status Change
		
		Thread.sleep(2000);
		WebElement chkbox = driver.findElement(By.xpath("//*[@data-statusid='14']"));
		...
		employee_Type.selectByVisibleText("Part Time");
		...
		//driver.findElement(By.id("mod_status_bill_rate")).sendKeys("12");
		WebElement payRate = driver.findElement(By.id("mod_status_pay_rate"));
		payRate.clear();
		payRate.sendKeys("13");
		
		WebElement chkBoxEmail = driver.findElement(By.xpath("//*[@data-module-status-trigger-id='764']"));
		if(!chkBoxEmail.isSelected())
			chkBoxEmail.click();
		Thread.sleep(1000);
		
		driver.findElement(By.xpath("//*[@name='trigger_subject_764']")).sendKeys(" Successfully");
		
		WebElement emailTemplate = driver.findElement(By.className("userEmailTemplatesListtrigger_764"));
