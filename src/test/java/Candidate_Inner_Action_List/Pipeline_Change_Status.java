...
public class Pipeline_Change_Status {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"table2_wrapper\"]/div[3]/div[3]/div[2]/div/table/tbody/tr[8]/td[2]/a")).click();
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[3]/a")).click(); // Pipeline Status Change
		
		Thread.sleep(2000);
		WebElement chkbox = driver.findElement(By.xpath("//*[@data-statusid='13']"));
		...
		WebElement source = driver.findElement(By.xpath("//*[@name='sourcer_id']"));
		Select Source = new Select(source);
		Source.selectByVisibleText("Career Portal");
		
		WebElement chkBoxEmail = driver.findElement(By.xpath("//*[@data-module-status-trigger-id='776']"));
		if(!chkBoxEmail.isSelected())
			chkBoxEmail.click();
		Thread.sleep(2000);
		
		WebElement emailTemplate = driver.findElement(By.className("userEmailTemplatesListtrigger_776"));
		...
		email_Tag.selectByVisibleText("Contact Name");
