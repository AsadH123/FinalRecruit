package GoalsQuotas_Action_List;
...
public class Hot_List {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.className("quotas_listing")).click();
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id=\"table2_wrapper\"]/div[3]/div[3]/div[2]/div/table/tbody/tr[1]/td[2]/a")).click();
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[5]/a")).click(); // HotList
		...
		Thread.sleep(2000);
		WebElement chkbox = driver.findElement(By.xpath("//*[@id=\"hotlist-listing-table\"]/tr[1]/td[1]/label/input"));
