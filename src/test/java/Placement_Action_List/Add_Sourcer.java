...
public class Add_Sourcer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@name='job_sourcers[585]']")))); 
		Select select = new Select(driver.findElement(By.xpath("//*[@name='job_sourcers[585]']"))); // Select Value Dropdown
