...
public class Add_Sourcer {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@data-original-title='Assign Sourcer']")))).click(); // Click on Assign Sourcer Icon
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@name='job_sourcers[1025]']")))); 
		Select select = new Select(driver.findElement(By.xpath("//*[@name='job_sourcers[1025]']"))); // Select Value Dropdown
		select.selectByVisibleText("asmar"); // Click on Dropdown Value
