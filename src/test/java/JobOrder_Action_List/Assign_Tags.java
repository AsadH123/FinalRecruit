...
public class Assign_Tags {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(1000);
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("li a.dropdown-toggle i.fa-ellipsis-h")))).click(); // Click on More Icon
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@placeholder='search tags']")).sendKeys("Test", Keys.ENTER); // Search Box
		driver.findElement(By.xpath("//*[@value='667']")).isSelected(); // Every CheckBox has a unique value_id
