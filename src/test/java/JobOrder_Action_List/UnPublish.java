...
public class UnPublish {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Click on job orders in which user wants to click unpublish button
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@data-original-title='Unpublish']")).click(); // Click on UnPublish Icon
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.className("sweet-alert"))));
