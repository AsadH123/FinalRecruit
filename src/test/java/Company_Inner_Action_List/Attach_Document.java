...
public class Attach_Document {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[3]/a")).click(); // Attach Document
		
		WebElement upload_file = driver.findElement(By.id("fileupload"));
		upload_file.sendKeys("C:\\Users\\Asad\\Desktop\\Candidates.csv");
		
		driver.findElement(By.xpath("//*[@name='document_title']")).sendKeys("Testing Companies Inner Listing");
