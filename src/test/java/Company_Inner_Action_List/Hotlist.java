...
public class Hotlist {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[4]/a")).click(); // Hotlist
		...
		Thread.sleep(2000);
		WebElement chkbox = driver.findElement(By.cssSelector("label.chkbox [data-item-id='503']"));
