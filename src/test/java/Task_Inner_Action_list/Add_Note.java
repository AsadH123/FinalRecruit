package Task_Inner_Action_list;
...
public class Add_Note {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.className("tasks_listing")).click();
		Thread.sleep(2000);
		
		driver.findElement(By.xpath("//*[@id=\"taskTable_wrapper\"]/div[3]/div[3]/div[2]/div/table/tbody/tr[1]/td[2]/a")).click();
		driver.findElement(By.xpath("/html/body/div[4]/div/div/div/div/div/div/ul/li[1]/a")).click(); // Add Note
		...
		driver.findElement(By.xpath("//*[@id=\"btn-addnotes\"]")).click();
	}
